...
data_array = np.zeros(shape=(20001,3842)) # Very important that this matches the number of timesteps in the main solver
x = np.arange(start=0,stop=2.0*np.pi,step=2.0*np.pi/3840)
iternum = 0
